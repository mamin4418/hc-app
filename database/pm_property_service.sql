...
CREATE TABLE `property_service` (
  ...
  PRIMARY KEY (`property_id`,`service`,`vendor_id`,`account`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Utilities info about property';
