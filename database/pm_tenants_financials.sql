...
--
-- Table structure for table `tenants_financials`
--

DROP TABLE IF EXISTS `tenants_financials`;
...
--
-- Dumping data for table `tenants_financials`
--

LOCK TABLES `tenants_financials` WRITE;
/*!40000 ALTER TABLE `tenants_financials` DISABLE KEYS */;
/*!40000 ALTER TABLE `tenants_financials` ENABLE KEYS */;
UNLOCK TABLES;
