...
DROP TABLE IF EXISTS `investor_docs`;
...
LOCK TABLES `investor_docs` WRITE;
/*!40000 ALTER TABLE `investor_docs` DISABLE KEYS */;
/*!40000 ALTER TABLE `investor_docs` ENABLE KEYS */;
UNLOCK TABLES;
